...
```
rename(dat_upsampleall2, c("X1987.x"="x", "X1997.x"="x", "X2003.x"="x", "X2008.x"="x", "X2014.x"="x","X1987.y"="y", "X1997.y"="y", "X2003.y"="y", "X2008.y"="y", "X2014.y"="y"))
...
+     numFolds <- trainControl(method = "cv", number = 10) ## ???
+     train2all <- PA_data2[train2,]
+     test2all <- PA_data2[test2, ]
