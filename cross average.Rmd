...
rfbc2 <- randomForest(formula= factor(change2) ~ . - landuse - change,
                       data = train22, n.trees=250,interaction.depth=7,
                       ## do.trace=1,
                       type="classification", proximity=TRUE, trcontrol=numFolds, keep.inbag = TRUE)
plot(rfbc2)
varImpPlot(rfbc2)
...
rfbc4 <- randomForest(formula= factor(change2) ~ . - landuse - change,
                       data = train44, n.trees=250,interaction.depth=7,
                       ## do.trace=1,
                       type="classification", proximity=TRUE, trcontrol=numFolds, keep.inbag = TRUE)
plot(rfbc4)
varImpPlot(rfbc4)
...
rfbc6 <- randomForest(formula= factor(change2) ~ . - landuse - change,
                       data = train66, n.trees=250,interaction.depth=7,
                       ## do.trace=1,
                       type="classification", proximity=TRUE, trcontrol=numFolds, keep.inbag = TRUE)
plot(rfbc4)
varImpPlot(rfbc6)
predbc6 <- predict(rfbc4, newdata=test66, typeprobs="prob", predict.all=TRUE)
...
rfbc7 <- randomForest(formula= factor(change2) ~ . - landuse - change,
                       data = train77, n.trees=250,interaction.depth=7,
                       ## do.trace=1,
                       type="classification", proximity=TRUE, trcontrol=numFolds, keep.inbag = TRUE)
plot(rfbc7)
varImpPlot(rfbc7)
